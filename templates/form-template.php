<?php
// Obtención de datos de las páginas de política de privacidad y cookies
...
?>
  ...
  <form method="post" action="" class="libro-reclamaciones-form">
	...
	<div class="form-group">
		...
		<input type="date" name="fecha_reclamacion" id="fecha_reclamacion" value="<?php echo date('Y-m-d'); ?>" required readonly>
	</div>
	...
	<div class="form-group">
      ...
      <div class="info-adicional" style="grid-column: span 3;">
        <ul class="notas-adicionales">
          ...
          <li>*El proveedor está obligado a responder al reclamo en un plazo máximo de quince (15) días hábiles.</li>
          <li><strong>Importante:</strong> La atención del reclamo es gratuita y no está condicionada a ningún pago.</li>
        ...
        <p>
          <input type="checkbox" name="declaracion_jurada" id="declaracion_jurada" required>
          Declaro que soy el dueño del servicio/producto y acepto el contenido de este formulario al declarar bajo Declaración Jurada la veracidad de los hechos descritos.
        </p>
        <p>
